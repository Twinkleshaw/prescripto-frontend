...
export default function EditDoctorModal({ doctor, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm px-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-xl max-h-[88vh] flex flex-col">
        {/* Header */}
          ...
          <div className="flex gap-2">
            ...
            {step < 3 ? (
              ...
              <button
                ...
                disabled={isPending}
                className="px-5 py-2 text-sm font-semibold text-white bg-primary hover:bg-primary-dark rounded-xl transition-colors disabled:opacity-60"
              >
