        ...
        <div className="min-w-0">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 mb-4">
            ...
            <div className="flex items-center gap-4 mb-5 flex-wrap">
              ...
              <div className="min-w-0">
                ...
                <button
                  onClick={() => fileRef.current?.click()}
                  className="px-3 py-1.5 text-[14px] font-semibold text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors"
                >
                  Change photo
                </button>
              </div>
            ...
            {profileSuccess && (
              <div className="flex items-center gap-2 mt-3 text-[14px] text-primary bg-teal-50 border border-teal-200 rounded-xl px-3 py-2">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 mb-5">
            ...
            <div className="space-y-3">
              ...
              {pwError && (
                <p className="text-[14px] text-red-500 bg-red-50 border border-red-200 rounded-xl px-3 py-2">
                  {pwError}
                </p>
              )}
              {pwSuccess && (
                <div className="flex items-center gap-2 text-[14px] text-primary bg-teal-50 border border-teal-200 rounded-xl px-3 py-2">
